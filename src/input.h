...
#ifdef USE_ALLEGRO
   INPUT_SCANCODE_ESC = __allegro_KEY_ESC, //59,
   INPUT_SCANCODE_BACKSPACE = __allegro_KEY_BACKSPACE, // 63,
   INPUT_SCANCODE_ENTER = __allegro_KEY_ENTER, //67,
   INPUT_SCANCODE_TAB = __allegro_KEY_TAB, //64,
   INPUT_SCANCODE_LEFT = __allegro_KEY_LEFT, //,
   INPUT_SCANCODE_RIGHT = __allegro_KEY_RIGHT, //83,
   INPUT_SCANCODE_UP = __allegro_KEY_UP, //84,
   INPUT_SCANCODE_DOWN = __allegro_KEY_DOWN, //85
